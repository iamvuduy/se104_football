    ...
    return (
        <div className="container mt-5">
            <div className="text-center mb-5">
                ...
                <p className="lead">Chọn một trong các tác vụ dưới đây để bắt đầu.</p>
            </div>
                    ...
                    <Link to="/register-team" className="text-decoration-none">
                        <div className="card dashboard-card h-100">
                            <div className="card-body text-center">
                                ...
                                <p className="card-text">Tiếp nhận hồ sơ đăng ký của các đội bóng mới.</p>
                            </div>
                        </div>
                    </Link>
                </div>
                    ...
                    <Link to="/teams" className="text-decoration-none">
                        <div className="card dashboard-card h-100">
                            <div className="card-body text-center">
                                ...
                                <p className="card-text">Xem và quản lý thông tin các đội bóng đã đăng ký.</p>
                            </div>
                        </div>
                    </Link>
                </div>
                            ...
                            <Link to="/admin/schedules" className="text-decoration-none">
                                <div className="card dashboard-card h-100">
                                    <div className="card-body text-center">
                                        ...
                                        <p className="card-text">Tạo và quản lý lịch thi đấu cho các vòng đấu.</p>
                                    </div>
                                </div>
                            </Link>
                        </div>
                            ...
                            <Link to="/admin/users" className="text-decoration-none">
                                <div className="card dashboard-card h-100">
                                    <div className="card-body text-center">
                                        ...
                                        <p className="card-text">Quản lý tài khoản và phân quyền người dùng.</p>
                                    </div>
                                </div>
                            </Link>
                        </div>
